...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className="w-3/12 absolute p-12 bg-black/80 my-36 mx-auto right-0 left-0 text-white rounded-2xl">
        ...
        <input 
          ...
          className="p-2 my-2 w-full bg-gray-700 text-white border border-gray-500"
        />
        <button className="p-2 my-2 bg-red-700 hover:bg-red-800 w-full rounded-lg">
